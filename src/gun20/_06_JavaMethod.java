...
public class _06_JavaMethod {
    public static void main(String[] args) {
        ...
        //parametreler aynı tip sadece miktarlerı farklı
    ...
    //1- bir method da parametre olarak sadece 1 tane olabilir
    //2- her zaman son parametre olmalı
    //gelen kaç sayı olursa olsun hepsini al dizi dizi şeklinde methoda al
    public static int toplamBul(int... sayilar){//kaç sayı gelirse gelsin onları dizi şekline alır
        int toplam=0;
