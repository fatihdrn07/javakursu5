...
public class _01_StringBufferAndStringBuilder {
    public static void main(String[] args) {
        ...
        //      ****   StringBuilderi biraz yakından tanıyalım   ****
        ...
        sb.append(4);  // eklenen herşeyi toString hali varsa çevirerek ekler
        System.out.println("sb = " + sb);
        ...
        sb.deleteCharAt(3);  // sadece belirtilen indexde ki karakteri siler
        System.out.println("sb = " + sb);
        ...
        sb.replace(3,8,"bu"); // verilen aralığa bu stringle değiştir
        System.out.println("sb = " + sb);
